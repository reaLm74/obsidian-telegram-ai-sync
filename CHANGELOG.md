...
## [0.3.1](https://github.com/reaLm74/obsidian-telegram-ai-sync/compare/0.3.0...0.3.1) (2026-02-21)

### Fixes

* fix Release Please PR number for automerge in update-version workflow
* add gh auth check to release scripts
